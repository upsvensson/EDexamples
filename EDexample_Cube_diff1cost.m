...
plot(nSRvec.^2,timingres,'-o')
grid
xlabel('Number of sources * number of receivers   [-]')
ylabel('Calculation time   [s]')
title('Calculation time for first-order diffraction, for the cube, one frequency')
