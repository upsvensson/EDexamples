% EDexample_Cube_edgepointsperwavelength.m
%
...
ylabel('Rel. error   [-]')
title('Rel. error, plane wave incidence onto a cube (ref. = best result)')
ylim([1e-7 0.1])
...
xlabel('Edge points per wavelength   [-]')
ylabel('Rel. error   [-]')
title('Rel. error, plane wave incidence onto a cube (ref. = extrapolated result)')
ylim([1e-7 0.1])
